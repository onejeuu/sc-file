...
**Reverse conversion back to game formats will not be accepted, regardless of implementation quality**. The project is intentionally unidirectional by design.
