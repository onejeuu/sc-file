...
Code is read far more often than it is written. Each component should have a single, clear responsibility and perform it well. Simplicity is preferred over cleverness. Performance is a default consideration, not an afterthought.
...
- Tests are optional but welcome
