...
DATA: dict[Lang, dict[str, str]] = {
    "EN": {
        ...
        "placeholder.animate.output": "Specify output GLB file...",
    ...
    "RU": {
        ...
        "placeholder.animate.output": "Укажите выходной файл GLB...",
