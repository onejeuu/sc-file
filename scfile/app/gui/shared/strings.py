...
DATA: dict[Lang, dict[str, str]] = {
    "EN": {
        ...
        "task.result.convert.simple": "Converted {converted} files",
        "task.result.convert": "Converted {converted}/{total} files",
    ...
    "RU": {
        ...
        "button.mapcache": "КОНВЕРТИРОВАТЬ",
        ...
        "task.result.convert.simple": "Конвертировано {converted} файлов",
        "task.result.convert": "Конвертировано {converted}/{total} файлов",
